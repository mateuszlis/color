...
class IRule
{
    ...
    public: // functions
        virtual std::string apply( const std::string& aLine, uint64_t aLineNumber = 0 ) const = 0;
}; // class IRule
...
class Rule : public IRule
{
    ...
    public: // functions
        ...
        virtual std::string apply( const std::string& aLine, uint64_t aLineNumber = 0 ) const;
        virtual ~Rule() {}
